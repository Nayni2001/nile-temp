...
const LabChemicals = () => {
  ...
  // Filter products based on search term, subgroup, and grade
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [allProducts, searchTerm, selectedSubgroup, selectedGrade]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              {/* Grade Filter */}
              <div className="flex flex-wrap gap-2">
                <span className="text-sm font-medium text-gray-700 px-2 py-1">Grade:</span>
                {grades.map((grade) => (
                  <button
                    key={grade}
            ...
            {(searchTerm || selectedSubgroup !== 'All' || selectedGrade !== 'All') && (
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
            {searchTerm || selectedSubgroup !== 'All' || selectedGrade !== 'All' ? 'Search Results' : 'Our Laboratory Chemical Products'}
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredProducts.map((product, index) => {
                ...
                return (
                  <Link
                    key={index}
                    to={`/products/lab-chemicals/${product.id}`}
                    ...
                    <div className="p-8">
                      ...
                      <div className="space-y-2 mb-6">
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium text-gray-900 font-mono">{product.molecularFormula || 'N/A'}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-500">Mol. Weight:</span>
                          <span className="font-medium text-gray-900">{product.molecularWeight || 'N/A'}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-600">{product.grade}</span>
                        </div>
