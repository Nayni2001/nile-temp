        ...
        <table className="w-full">
          <thead>
            <tr className="bg-orange-50">
              ...
              {product.specifications.some(spec => spec.result) && (
          ...
          <tbody className="divide-y divide-gray-200">
            {product.specifications.map((spec, index) => (
              <tr key={index} className="hover:bg-gray-50">
                ...
                {product.specifications.some(s => s.result) && (
                  <td className="px-4 py-3 text-sm font-medium text-orange-600">{spec.result || '---'}</td>
                )}
              </tr>
            ))}
          </tbody>
