...
import { ArrowLeft, Zap, Shield, Award, CheckCircle, ArrowRight, Beaker, Globe, Search, X, FlaskRound as Flask, Atom, TestTube } from 'lucide-react';
import { phaseTransferCatalystsData, getProductColor, getProductId } from '../../../data/phaseTransferCatalystsData';

const PhaseTransferCatalysts = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const products = phaseTransferCatalystsData.details.products;
  ...
  const features = [
    {
      ...
      description: 'Accelerate chemical reactions and improve efficiency'
    },
    {
      icon: Shield,
      title: 'High Purity',
      description: 'Ultra-pure quaternary ammonium compounds'
    },
    {
      icon: Globe,
      title: 'Versatile Applications',
      description: 'Suitable for various organic synthesis reactions'
    },
    {
      icon: Beaker,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
            Phase Transfer <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-600">Catalysts</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            {phaseTransferCatalystsData.details.description}
          </p>
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Our comprehensive range includes tetrabutylammonium, benzyltrimethylammonium, and phosphonium salts designed to facilitate efficient phase transfer in organic synthesis.
          </p>
        </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-4 bg-white border border-gray-300 rounded-2xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-900 placeholder-gray-500 text-lg"
              />
              {searchTerm && (
                <button
                  onClick={clearSearch}
              ...
              <div className="mt-4 text-center">
                <p className="text-gray-600">
                  {filteredProducts.length === 0 ? (
                    ...
                    <>
                      Found <span className="font-semibold text-orange-600">{filteredProducts.length}</span> 
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
            {searchTerm ? 'Search Results' : 'Our Phase Transfer Catalyst Products'}
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredProducts.map((product, index) => {
                ...
                return (
                  <Link
                    key={index}
                    to={`/products/phase-transfer-catalysts/${productId}`}
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-8 lg:p-12 text-white mb-16">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-6">Catalytic Excellence</h2>
            <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
              Our phase transfer catalysts are designed to enhance reaction efficiency, reduce reaction times, and improve yields in organic synthesis applications.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <Flask className="w-8 h-8 mx-auto mb-3" />
                <h3 className="font-bold mb-2">Enhanced Efficiency</h3>
                <p className="text-orange-100 text-sm">Improved reaction rates and yields</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <TestTube className="w-8 h-8 mx-auto mb-3" />
                <h3 className="font-bold mb-2">Quality Control</h3>
                <p className="text-orange-100 text-sm">Rigorous purity testing</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <Award className="w-8 h-8 mx-auto mb-3" />
                <h3 className="font-bold mb-2">Industry Standards</h3>
                <p className="text-orange-100 text-sm">Meeting global requirements</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-8 lg:p-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Need Phase Transfer Catalysts for Your Synthesis?
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Contact our technical team to discuss your specific catalyst requirements. We provide custom solutions and expert guidance for optimal reaction conditions.
          </p>
...
export default PhaseTransferCatalysts;